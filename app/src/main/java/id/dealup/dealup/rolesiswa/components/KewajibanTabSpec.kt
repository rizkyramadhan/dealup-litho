...
object KewajibanTabSpec {
            ...
            .child(
                if (loading)
                    ...
                    DataDiffSection.create<JSONObject>(c)
                        ...
                        .renderEventHandler(KewajibanTab.onRender(c))
            )
            .build()
    }
    ...
    private fun generateData(json: String): ArrayList<JSONObject> {
        ...
        val kewajiban = JSONArray(json)
        val jArray = kewajiban as JSONArray
